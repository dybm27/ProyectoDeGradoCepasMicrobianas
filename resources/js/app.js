...
if(ruta.includes('perfil')){
...
}else if(ruta.includes('otra-info')){
...
}else if(ruta.includes('usuarios')){
    Vue.component('usuarios', require('./components/gestionar_usuarios/UsuariosComponent.vue').default);
    Vue.component('acciones_tabla_usuarios', require('./components/gestionar_usuarios/usuarios/AccionesComponent.vue').default);
}else if(ruta.includes('imagenes-login')){
    Vue.component('imagenes-login', require('./components/imagenes-login/ImagenesLoginComponent.vue').default);
 }else if(ruta.includes('quienes-somos')){
    Vue.component('quienes-somos', require('./components/sitio-web/QuienesSomosComponent.vue').default);
}else if(ruta.includes('investigadores')){
  ...
  }else if(ruta.includes('equipamientos')){
  ...
  }else if(ruta.includes('publicidad')){
...
}else if(ruta.includes('documentos')){

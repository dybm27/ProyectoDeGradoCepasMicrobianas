    ...
    validarNombre() {
      ...
      if (this.parametros.nombre) {
        if (!letters.test(this.parametros.nombre)) {
          ...
          if (this.getPublicacionByNombre(this.parametros.nombre)) {
            if (
              this.getPublicacionByNombre(this.parametros.nombre).id !=
              this.info.id
            ) {
              this.mensajeNombre = "Ya existe una publicacion con ese nombre";
              return true;
            }
            return false;
          }

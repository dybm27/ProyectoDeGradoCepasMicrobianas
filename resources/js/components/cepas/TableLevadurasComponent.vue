          ...
          >
            ...
            <tbody>
              <tr v-for="(cepa,index) in getCepas" :key="index">
                ...
                <td>{{cepa.gene_ro}}</td>
                <td>{{cepa.espe_cie}}</td>
                <td>{{getLevaduras[index].divi_sion}}</td>
                <td>{{getLevaduras[index].cla_se}}</td>
                <td>{{getLevaduras[index].or_den}}</td>
                <td>{{getLevaduras[index].fami_lia}}</td>
                <td>{{cepa.estado}}</td>
                <td>{{cepa.origen}}</td>
                <td>
...
export default {
  ...
  methods: {
    ...vuex.mapActions(["obtenerCepasLevaduras", "obtenerLevaduras"]),
    verCepa(cepa, index) {},
  ...
  computed: {
    ...vuex.mapGetters(["getLevaduras", "getCepas", "getCheckboxs"]),
    ...vuex.mapState(["cepas", "checkboxs"])
  },
  created() {

...
export default {
  ...
  methods: {
    ...
    evento() {
      if (this.tituloForm === "Agregar Característica") {
        ...
        axios
          .post("/cepas/actinomiceto/caract-micro", formData, {
    ...
    appendInfo(formData) {
      ...
      formData.append(
        "forma_estructura_reproduccion",
        this.parametros.forma_estructura_reproduccion
      );
      formData.append("tincion", this.parametros.tincion);
      formData.append("micelio", this.parametros.micelio);
  ...
  computed: {
    ...vuex.mapGetters(["getInfoCaractMicroActinomicetos"]),
    required() {
      if (this.tituloForm === "Agregar Característica") {
        return true;
      } else {

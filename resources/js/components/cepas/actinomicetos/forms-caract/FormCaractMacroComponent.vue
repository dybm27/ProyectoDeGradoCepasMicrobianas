          ...
          <div class="main-card mb-3 card">
            <div class="card-body">
              ...
              <form @submit.prevent="evento">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-6">
                      ...
                      <em
                        v-if="
                          $v.parametros.pigmento.$error &&
                          !$v.parametros.pigmento.required
                        "
                        class="text-error-select"
                        >{{ mensajes.required }}</em
                      >
                ...
                <div class="position-relative form-group">
                  <label for="secrecion_geosminas" class
                    >Secreción de Geosminas</label
                  >
                  <input
                    ...
                    :class="[
                      'form-control',
                      $v.parametros.secrecion_geosminas.$error
                        ? 'error-input-select'
                        : '',
                    ]"
                  ...
                  <em
                    v-if="
                      $v.parametros.secrecion_geosminas.$error &&
                      !$v.parametros.secrecion_geosminas.required
                    "
                    class="text-error-input"
                    >{{ mensajes.required }}</em
                  >

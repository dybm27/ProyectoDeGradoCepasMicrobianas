<template>
  <div>
        ...
        <div class="card-header-tab card-header">
          ...
          <div class="btn-actions-pane-right text-capitalize">
            ...
            <button
              ...
              @click="$modal.show('eliminar_caract_macro_hongo')"
              class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-danger btn-sm"
    ...
    <modal name="eliminar_caract_macro_hongo" classes="my_modal" :width="400" :height="300">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Eliminar Característica Macroscópica</h5>
          <button type="button" class="close" @click="$modal.hide('eliminar_caract_macro_hongo')">
        ...
        <div class="modal-footer">
          <button
            ...
            @click="$modal.hide('eliminar_caract_macro_hongo')"
          >Cancelar</button>

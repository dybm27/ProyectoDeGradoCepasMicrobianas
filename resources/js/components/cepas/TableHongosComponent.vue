          ...
          >
            ...
            <tbody>
              <tr v-for="(cepa,index) in getCepas" :key="index">
                ...
                <td>{{cepa.gene_ro}}</td>
                <td>{{cepa.espe_cie}}</td>
                <td>{{getHongos[index].phy_lum}}</td>
                <td>{{getHongos[index].cla_se}}</td>
                <td>{{getHongos[index].or_den}}</td>
                <td>{{getHongos[index].fami_lia}}</td>
                <td>{{cepa.estado}}</td>
                <td>{{cepa.origen}}</td>
                <td>
...
export default {
  ...
  methods: {
    ...vuex.mapActions(["obtenerCepasHongos", "obtenerHongos"]),
    verCepa(cepa, index) {},
  ...
  computed: {
    ...vuex.mapGetters(["getHongos", "getCepas", "getCheckboxs"]),

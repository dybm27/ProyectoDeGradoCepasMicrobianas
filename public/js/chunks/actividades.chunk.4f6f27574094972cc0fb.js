...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    evento: function evento() {
      ...
      if (!this.$v.$invalid) {
        if (this.tituloForm === "Agregar Actividad") {
          ...
          axios.put("/difusion/".concat(this.idActividad), this.parametros).then(function (res) {
            _this.bloquearBtn = false;
  ...
  computed: _objectSpread(_objectSpread({}, vuex__WEBPACK_IMPORTED_MODULE_0__["default"].mapGetters("publicidad", ["getActividadById", "getActividadByTitulo", "getActividadByPublicar"])), {}, {
    ...
    validarPublicacion: function validarPublicacion() {
      ...
      if (this.getActividadByPublicar.find(function (actividad) {

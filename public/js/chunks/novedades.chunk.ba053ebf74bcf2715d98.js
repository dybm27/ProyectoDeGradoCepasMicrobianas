...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    evento: function evento() {
      ...
      if (!this.$v.$invalid) {
        if (this.tituloForm === "Agregar Novedad") {
          axios.post("/difusion", this.parametros).then(function (res) {
          ...
          axios.put("/difusion/".concat(this.idNovedad), this.parametros).then(function (res) {
            _this.bloquearBtn = false;
  ...
  computed: _objectSpread(_objectSpread({}, vuex__WEBPACK_IMPORTED_MODULE_0__["default"].mapGetters("publicidad", ["getNovedadById", "getNovedadByTitulo", "getNovedadByPublicar"])), {}, {
    ...
    validarPublicacion: function validarPublicacion() {
      ...
      if (this.getNovedadByPublicar.find(function (novedad) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, vuex__WEBPACK_IMPORTED_MODULE_3__["default"].mapGetters("publicidad", ["getNovedades"])), {}, {
  ...
  methods: _objectSpread(_objectSpread({}, vuex__WEBPACK_IMPORTED_MODULE_3__["default"].mapActions("publicidad", ["accionNovedad"])), {}, {

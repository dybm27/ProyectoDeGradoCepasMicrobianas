(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["agregar-caract"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.$emit("rutaHijo", "/cepas/form-agregar");
  },
  data: function data() {
    return {};
  },
  methods: _objectSpread({}, vuex__WEBPACK_IMPORTED_MODULE_0__["default"].mapActions(["obtenerCepa", "obtenerInfoCaractBacterias"])),
...
var render = function() {
  ...
  return _c("div", [
    _vm.getCepa != ""
      ? _c("div", [
          _vm.getCepa[0].cepa.grupo_microbiano_id == 1
            ? _c("div", [_c("nav-bacterias")], 1)
            : _vm.getCepa[0].cepa.grupo_microbiano_id == 2
            ? _c("div", [_c("nav-hongos")], 1)
            : _vm.getCepa[0].cepa.grupo_microbiano_id == 3

...
class InfoPanelCepasController extends Controller
{
    ...
    public function metodosBacterias(Request $request)
    {
    ...
    public function metodosHongos(Request $request)
    {
    ...
    public function metodosLevaduras(Request $request)
    {
    ...
    public function infoTiposCepas()
    {
    ...
    public function infoCaractBacterias()
    {
    ...
    public function infoCaractHongos()
    {
    ...
    public function infoCaractLevaduras()
    {
    ...
    public function infoCaractActinomicetos()
    {

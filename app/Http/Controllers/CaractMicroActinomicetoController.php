...
class CaractMicroActinomicetoController extends Controller
{
    public function store(Request $request)
    {
        ...
        $caractMicroActinomiceto->descripcion = $request->descripcion_imagenes;
    ...
    public function agregarImagen(Request $request, $id)
    {
        ...
        $imagen = $this->guardarImagen($request->file('imagen'), $caractMicroActinomiceto->actinomiceto_id);
    ...
    public function guardarImagen($file, $id)
    {
        ...
        Storage::disk('local')->put('/public/actinomicetos/caract_micro_img/' . $id . '/' . $time . '-' . $fileName, file_get_contents($file));
        $ruta = '/public/actinomicetos/caract_micro_img/' . $id . '/' . $time . '-' . $fileName;
        $rutaPublica = '/storage/actinomicetos/caract_micro_img/' . $id . '/' . $time . '-' . $fileName;

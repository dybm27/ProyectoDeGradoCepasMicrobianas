...
class TiposMetodosBacteriasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = TipoMetodoConservacionBacteria::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Tipos Metodos Bacterias")
                    ->setDescription(
                        "Documento con los Tipos Metodos Bacterias, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => TipoMetodoConservacionBacteria::all(),
            'titulo' => 'Tipos Metodos Bacterias'
        ]);
    }
}

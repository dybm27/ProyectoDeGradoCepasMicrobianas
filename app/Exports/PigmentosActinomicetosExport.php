...
class PigmentosActinomicetosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = PigmentoActinomiceto::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Pigmentos Actinomicetos")
                    ->setDescription(
                        "Documento con los Pigmentos Actinomicetos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => PigmentoActinomiceto::all(),
            'titulo' => 'Pigmentos Actinomicetos'
        ]);
    }
}

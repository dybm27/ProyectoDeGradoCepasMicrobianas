...
class ColorsHongosExport implements FromView, WithEvents
{
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Colores Hongos")
                    ->setDescription(
                        "Documento con los Colores Hongos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => ColorHongo::all(),
            'titulo' => 'Colores Hongos'
        ]);
    }
}

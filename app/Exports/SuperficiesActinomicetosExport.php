...
class SuperficiesActinomicetosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = SuperficieActinomiceto::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Superficies Actinomicetos")
                    ->setDescription(
                        "Documento con las Superficies Actinomicetos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => SuperficieActinomiceto::all(),
            'titulo' => 'Superficies Actinomicetos'
        ]);
    }
}

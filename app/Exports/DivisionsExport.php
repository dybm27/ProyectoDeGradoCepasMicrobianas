...
class DivisionsExport implements FromView, WithEvents
{
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Divisiones Cepas")
                    ->setDescription(
                        "Documento con las Divisiones Cepas, generado usando PHP."
                    );
            },

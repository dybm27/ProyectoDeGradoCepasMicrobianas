...
class TincionsActinomicetosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = TincionGramActinomiceto::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Tinción de Gram Actinomicetos")
                    ->setDescription(
                        "Documento con las Tinción de Gram Actinomicetos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => TincionGramActinomiceto::all(),
            'titulo' => 'Tinción de Gram Actinomicetos'
        ]);
    }
}

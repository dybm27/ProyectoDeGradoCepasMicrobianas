...
class TiposAgarsBacteriasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = TipoAgarBacteria::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Tipos Agars Actinomicetos")
                    ->setDescription(
                        "Documento con los Tipos Agars Actinomicetos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => TipoAgarBacteria::all(),
            'titulo' => 'Tipos Agars Actinomicetos'
        ]);
    }
}

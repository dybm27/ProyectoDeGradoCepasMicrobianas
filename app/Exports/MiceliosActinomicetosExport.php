...
class MiceliosActinomicetosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = MicelioActinomiceto::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Micelios Actinomicetos")
                    ->setDescription(
                        "Documento con los Micelios Actinomicetos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => MicelioActinomiceto::all(),
            'titulo' => 'Micelios Actinomicetos'
        ]);
    }
}

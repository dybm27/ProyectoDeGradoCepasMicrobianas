...
class EsporasAsexualHongosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = EsporaAsexualHongo::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Esporas Asexuales Hongos")
                    ->setDescription(
                        "Documento con las Esporas Asexuales Hongos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => EsporaAsexualHongo::all(),
            'titulo' => 'Esporas Asexuales Hongos'
        ]);
    }
}

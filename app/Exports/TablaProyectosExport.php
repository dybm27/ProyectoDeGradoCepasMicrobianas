...
class TablaProyectosExport implements FromView, WithEvents
{
    protected $datos;
    protected $cantidad;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Proyectos Majumba")
                    ->setDescription(
                        "Documento con los Proyectos Majumba, generado usando PHP."
                    );
            },
            ...
            BeforeSheet::class => function (BeforeSheet $event) use ($styleArray1, $styleArray2) {
                ...
                $event->sheet->getStyle('A3:B' . $this->cantidad)
    ...
    {
        return view('excel.tablas.documentos', [
            'datos' => $this->datos, 'titulo' => 'Proyectos'
        ]);
    }
}

...
class ElevacionsBacteriasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = ElevacionBacteria::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Elevaciones Bacterias")
                    ->setDescription(
                        "Documento con las Elevaciones Bacterias, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => ElevacionBacteria::all(),
            'titulo' => 'Elevaciones Bacterias'
        ]);
    }
}

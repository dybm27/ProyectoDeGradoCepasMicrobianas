...
class FormasMacroActinomicetosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = FormaCaractMacroActinomiceto::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Formas Macroscópicas Actinomicetos")
                    ->setDescription(
                        "Documento con las Formas Macroscópicas Actinomicetos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => FormaCaractMacroActinomiceto::all(),
            'titulo' => 'Formas Macroscópicas Actinomicetos'
        ]);
    }
}

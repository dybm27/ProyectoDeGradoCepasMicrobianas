...
class TablaTincionsActinomicetosExport implements FromView, WithEvents
{
    protected $datos;
    protected $cantidad;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Tincion De Gram Hongos")
                    ->setDescription(
                        "Documento con las Tincion De Gram Hongos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tablas.tipos', [
            'datos' => $this->datos,
            'titulo' => 'Tincion De Gram Actinomicetos'
        ]);
    }
}

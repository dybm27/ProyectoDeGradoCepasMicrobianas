...
class TablaTiposAgarsBacteriasExport implements FromView, WithEvents
{
    protected $datos;
    protected $cantidad;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Tipos Agars Bacterias")
                    ->setDescription(
                        "Documento con los Tipos Agars Bacterias, generado usando PHP."
                    );
            },

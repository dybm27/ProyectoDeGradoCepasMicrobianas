...
class ActividadesExport implements FromView, WithEvents
{
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Excel Actividades MAJUMBA")
                    ->setDescription(
                        "Documento con las Actividades del Grupo de investigacion MAJUMBA
                        , generado usando PHP."
                    );
            },

...
class ConidioforosHongosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = ConidioforoHongo::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Conidioforos Hongos")
                    ->setDescription(
                        "Documento con los Conidioforos Hongos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => ConidioforoHongo::all(),
            'titulo' => 'Conidioforos Hongos'
        ]);
    }
}

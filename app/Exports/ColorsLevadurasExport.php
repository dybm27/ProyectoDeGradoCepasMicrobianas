...
class ColorsLevadurasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = ColorLevadura::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Colores Levaduras")
                    ->setDescription(
                        "Documento con los Colores Levaduras, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => ColorLevadura::all(),
            'titulo' => 'Colores Levaduras'
        ]);
    }
}

...
class EsporasSexualHongosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = EsporaSexualHongo::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Esporas Sexuales Hongos")
                    ->setDescription(
                        "Documento con las Esporas Sexuales Hongos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => EsporaSexualHongo::all(),
            'titulo' => 'Esporas Sexuales Hongos'
        ]);
    }
}

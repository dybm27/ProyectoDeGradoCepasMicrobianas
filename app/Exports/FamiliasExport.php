...
class FamiliasExport implements FromView, WithEvents
{
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Familias Cepas")
                    ->setDescription(
                        "Documento con las Familias Cepas, generado usando PHP."
                    );
            },

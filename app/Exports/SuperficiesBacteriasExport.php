...
class SuperficiesBacteriasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = SuperficieBacteria::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Superficies Bacterias")
                    ->setDescription(
                        "Documento con las Superficies Bacterias, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => SuperficieBacteria::all(),
            'titulo' => 'Superficies Bacterias'
        ]);
    }
}

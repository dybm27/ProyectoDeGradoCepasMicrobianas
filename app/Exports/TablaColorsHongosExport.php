...
class TablaColorsHongosExport implements FromView, WithEvents
{
    protected $datos;
    protected $cantidad;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Colores Hongols")
                    ->setDescription(
                        "Documento con los Colores Hongols, generado usando PHP."
                    );
            },

...
class EquipamientosExport implements FromView, WithEvents
{
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Equipamientos MAJUMBA")
                    ->setDescription(
                        "Documento con los Equipamientos MAJUMBA, generado usando PHP."
                    );
            },
    ...
    {
        return view('excel.equipamientos', [

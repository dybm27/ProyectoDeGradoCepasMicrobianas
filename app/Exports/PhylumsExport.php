...
class PhylumsExport implements FromView, WithEvents
{
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Phylums Cepas")
                    ->setDescription(
                        "Documento con las Phylums Cepas, generado usando PHP."
                    );
            },

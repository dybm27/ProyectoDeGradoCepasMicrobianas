...
class FormasMicroActinomicetosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = FormaCaractMicroActinomiceto::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Formas Microscópicas Actinomicetos")
                    ->setDescription(
                        "Documento con las Formas Microscópicas Actinomicetos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => FormaCaractMicroActinomiceto::all(),
            'titulo' => 'Formas Microscópicas Actinomicetos'
        ]);
    }
}

...
class ConidioforosActinomicetosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = ConidioforoActinomiceto::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Conidioforos Actinomicetos")
                    ->setDescription(
                        "Documento con los Conidioforos Actinomicetos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => ConidioforoActinomiceto::all(),
            'titulo' => 'Conidioforos Actinomicetos'
        ]);
    }
}

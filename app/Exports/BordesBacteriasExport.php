...
class BordesBacteriasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = BordeBacteria::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Bordes Bacterias")
                    ->setDescription(
                        "Documento con los Bordes Bacterias, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => BordeBacteria::all(),
            'titulo' => 'Bordes Bacterias'
        ]);
    }
}

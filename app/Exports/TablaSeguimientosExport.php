...
class TablaSeguimientosExport implements FromView, WithEvents
{
    protected $datos;
    protected $cantidad;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Excel Seguimientos")
                    ->setDescription(
                        "Documento con el registro de las acciones realizadas por los usuairos del sistema,
                         generado usando PHP."
                    );
            },
            ...
            BeforeSheet::class => function (BeforeSheet $event) use ($styleArray1, $styleArray2) {
                ...
                $event->sheet->getStyle('A3:E' . $this->cantidad)
    ...
    {
        return view('excel.tablas.seguimientos', [
            'datos' => $this->datos
        ]);
    }
}

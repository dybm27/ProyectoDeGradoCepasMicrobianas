...
class TexturasLevadurasExport implements  FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = TexturaLevadura::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Texturas Levaduras")
                    ->setDescription(
                        "Documento con las Texturas Levaduras, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => TexturaLevadura::all(),
            'titulo' => 'Texturas Levaduras'
        ]);
    }
}

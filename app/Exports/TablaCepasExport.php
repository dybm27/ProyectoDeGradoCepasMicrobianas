...
class TablaCepasExport implements FromView, WithEvents
{
    protected $datos;
    protected $cantidad;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Excel Cepas Microbianas")
                    ->setDescription(
            ...
            BeforeSheet::class => function (BeforeSheet $event) use ($styleArray1, $styleArray2) {
                ...
                $event->sheet->getStyle('A3:G' . $this->cantidad)
    ...
    {
        return view('excel.tablas.cepas', [
            'datos' => $this->datos
        ]);
    }
}

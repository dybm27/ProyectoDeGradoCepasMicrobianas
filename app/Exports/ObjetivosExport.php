...
class ObjetivosExport implements FromView, WithEvents
{
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Objetivos Majumba")
                    ->setDescription(
                        "Documento con las Objetivos Majumba, generado usando PHP."
                    );
            },

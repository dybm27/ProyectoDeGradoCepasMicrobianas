...
class FormasMacroBacteriasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = FormaCaractMacroBacteria::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Formas Macroscópicas Bacterias")
                    ->setDescription(
                        "Documento con las Formas Macroscópicas Bacterias, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => FormaCaractMacroBacteria::all(),
            'titulo' => 'Formas Macroscópicas Bacterias'
        ]);
    }
}

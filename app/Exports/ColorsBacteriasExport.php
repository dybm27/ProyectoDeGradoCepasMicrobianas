...
class ColorsBacteriasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = ColorBacteria::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Colores Bacterias")
                    ->setDescription(
                        "Documento con los Colores Bacterias, generado usando PHP."
                    );
            },

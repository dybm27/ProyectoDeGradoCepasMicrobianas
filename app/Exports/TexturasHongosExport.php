...
class TexturasHongosExport implements FromView, WithEvents
{
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Texturas Hongos")
                    ->setDescription(
                        "Documento con las Texturas Hongos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => TexturaHongo::all(),
            'titulo' => 'Texturas Hongos'
        ]);
    }
}

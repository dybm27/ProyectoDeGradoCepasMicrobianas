...
class TiposMetodosLevadurasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = TipoMetodoConservacionLevadura::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Tipos Metodos Levaduras")
                    ->setDescription(
                        "Documento con los Tipos Metodos Levaduras, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => TipoMetodoConservacionLevadura::all(),
            'titulo' => 'Tipos Metodos Levaduras'
        ]);
    }
}

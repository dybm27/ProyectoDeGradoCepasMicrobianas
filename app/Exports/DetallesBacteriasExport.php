...
class DetallesBacteriasExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = DetalleOpticoBacteria::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Detalles Ópticos Bacterias")
                    ->setDescription(
                        "Documento con los Detalles Ópticos Bacterias, generado usando PHP."
                    );
            },

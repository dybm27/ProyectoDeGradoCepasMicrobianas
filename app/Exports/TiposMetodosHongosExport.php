...
class TiposMetodosHongosExport implements FromView, WithEvents
{
    public function registerEvents(): array
    {
        ...
        $cantidad = TipoMetodoConservacionHongo::count() + 2;
        ...
        return [
            ...
            BeforeExport::class => function (BeforeExport $event) use ($descargo) {
                $event->writer->getProperties()->setCreator('Dumar Basto')
                    ...
                    ->setTitle("Tipos Metodos Hongos")
                    ->setDescription(
                        "Documento con los Tipos Metodos Hongos, generado usando PHP."
                    );
            },
    ...
    public function view(): View
    {
        return view('excel.tipos', [
            'tipos' => TipoMetodoConservacionHongo::all(),
            'titulo' => 'Tipos Metodos Hongos'
        ]);
    }
}
